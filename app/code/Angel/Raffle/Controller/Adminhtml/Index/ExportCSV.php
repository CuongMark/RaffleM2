...
class ExportCSV extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        try {
            ...
            $fileName = 'Raffleaffle-'.$date.'.csv';
            $this->pageFactory = $this->pageFactory->create();
            $exportBlock = $this->pageFactory->getLayout()->createBlock('Angel\Raffle\Block\Adminhtml\Raffle\Grid');;
    ...
    {
        return $this->_authorization->isAllowed('Angel_Raffle::report');
    }
}
