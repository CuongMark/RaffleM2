...
class Edit extends \Angel\Raffle\Controller\Adminhtml\Ticket
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Angel\Raffle\Model\Ticket::class);
        ...
        $this->_coreRegistry->register('angel_raffle_ticket', $model);
