...
namespace Angel\Raffle\Block\Adminhtml\Raffle\Details\Ticket;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $this->raffle->joinProductNameToTicketsCollection($collection);
        $this->raffle->joinCustomerEmailToTicketsCollection($collection);
    ...
    protected function _prepareColumns()
    {
        try {
            ...
            $this->addColumn('customer_email', array(
                ...
                'renderer' => 'Angel\Raffle\Block\Adminhtml\Raffle\Renderer\Customer'
            ));
        ...
        $this->addExportType('*/ticket/exportCSV', __('CSV'));
